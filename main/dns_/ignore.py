...
class Modify_ip(object):
    ...
    def AddIpMemory(self):
        try:
            ...
            print('[dns AddIpMemory function]',e)
...
class  Ig(object):
    ...
    def verify_time_ignore(self):
        try:
            ...
            print('[dns verify_time_ignore function]',e)
    ...
    def verify_always_ignore(self):
        try:
            ...
            print('[dns verify_always_ignore function]',e)
