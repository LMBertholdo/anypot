...
class Hour_verify(object):
    ...
    #       verify time
            ...
            print('[chargen Verify function]',e)
...
class Modify_ip(object):
    ...
    def AddIpMemory(self):
        try:
            ...
            print('[chargen AddIpMemory function]',e)
    ...
    def Remove(self):
        try:
            ...
            print('[chargen Modify_ip function]',e)
...
class  Ig(object):
    ...
    def verify_time_ignore(self):
        try:
            ...
            print('[chargen verify_time_ignore function]',e)
    ...
    def verify_always_ignore(self):
        try:
            ...
            print('[chargen verify_always_ignore function]', e)
