...
class Modify_ip(object):
    ...
    def AddIpMemory(self):
        try:
            ...
            print('[cldap AddIpMemory function]',e)
    ...
    def Remove(self):
        try:
            ...
            print('[cldap Modify_ip function]',e)
...
class  Ig(object):
    ...
    def verify_time_ignore(self):
        try:
            ...
            print('[cldap verify_time_ignore function]',e)
    ...
    def verify_always_ignore(self):
        try:
            ...
            print('[cldap verify_always_ignore function]', e)
