...
class Hour_verify(object):
    ...
    #       verify time
            ...
            print('[Memcached Verify function]',e)
...
class Modify_ip(object):
    ...
    def AddIpMemory(self):
        try:
            ...
            print('[Memcached AddIpMemory function]',e)
    ...
    def Remove(self):
        try:
            ...
            print('[Memcached Modify_ip function]',e)
...
class  Ig(object):
    ...
    def verify_time_ignore(self):
        try:
            ...
            print('[Memcached verify_time_ignore function]',e)
    ...
    def verify_always_ignore(self):
        try:
            ...
            print('[Memcached verify_always_ignore function]', e)
