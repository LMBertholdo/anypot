...
class Modify_ip(object):
    ...
    def AddIpMemory(self):
        try:
            ...
            print('[qotd AddIpMemory function]',e)
...
class  Ig(object):
    ...
    def verify_time_ignore(self):
        try:
            ...
            print('[qotd verify_time_ignore function]',e)
    ...
    def verify_always_ignore(self):
        try:
            ...
            print('[qotd verify_always_ignore function]',e)
